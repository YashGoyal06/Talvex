  ...
  return (
    <div className="space-y-8 select-none max-w-[1400px] mx-auto pb-20 animate-fade-in text-neutral-800">
      ...
      <div className="bg-white/70 backdrop-blur-xl border border-white/40 p-8 rounded-[2.2rem] shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <h2 className="text-3xl font-black text-neutral-950 tracking-tight">Interviews</h2>
                              ...
                              <div className="flex justify-between items-start gap-4 flex-wrap sm:flex-nowrap">
                                <div>
                                  ...
                                  <p className="text-xs font-semibold text-neutral-400 mt-1">
                                    {interview.job ? interview.job.title : 'Developer'} • Live Technical Coding Assessment
                                  </p>
                                </div>
                          ...
                          <div className="flex justify-between items-center gap-4 flex-wrap sm:flex-nowrap">
                            <div>
                              ...
                              <p className="text-[10px] text-neutral-400 mt-1 font-bold">
                                {dateObj.toLocaleDateString()} @ {dateObj.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })} · {interview.job ? interview.job.title : 'Developer'}
                              </p>
                            </div>
                            <div className="flex items-center gap-2 shrink-0">
                              <button
            ...
            <form onSubmit={handleRescheduleSubmit}>
              ...
              <div className="p-6 space-y-4">
                <div className="text-xs text-neutral-500 leading-relaxed font-semibold bg-neutral-50 p-4 rounded-2xl border border-neutral-200/50 mb-2">
                  Rescheduling live session for <strong className="text-neutral-955">{selectedInterview.candidate ? `${selectedInterview.candidate.first_name} ${selectedInterview.candidate.last_name}` : 'Candidate'}</strong> for role <strong className="text-neutral-950">{selectedInterview.job?.title || 'Engineer'}</strong>.
                </div>
